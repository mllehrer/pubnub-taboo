...
get the app created:
    ...
    $ heroku apps:create taboo-game
    Creating taboo-game... done, stack is cedar
    http://taboo-game.herokuapp.com/ | git@heroku.com:taboo-game.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://taboo-game.herokuapp.com deployed to Heroku

    To git@heroku.com:taboo-game.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://taboo-game.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@taboo-game.herokuapp.com/repl
